...
public class ApplicationConfig {
    ...
    public Map<String, Course> buildPortfolio() {
        Map<String, Course> portfolio = new HashMap<>();
    ...
    @Bean(name="courseUpdates")
    public PairedQueueAndFlux<CourseUpdateMessage> buildCourseUpdatesFlux() {
        return new PairedQueueAndFlux<CourseUpdateMessage>();
    }

    @Bean(name="courses")
    public PairedQueueAndFlux<Course> buildCoursesFlux() {
        return new PairedQueueAndFlux<>();
    }
}
